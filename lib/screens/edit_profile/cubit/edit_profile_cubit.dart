  ...
  void submit() async {
    ...
    try {
      ...
      if (state.profileImage != null) {
        profileImageUrl = await _storageRepository.uploadProfileImage(url: profileImageUrl, image: state.profileImage!);
      }
      ...
      emit(state.copyWith(
        ...
        failure: Failure(message: 'Cannot update your profile'),
      ));
    }
  }
}
